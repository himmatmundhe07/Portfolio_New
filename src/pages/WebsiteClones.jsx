    ...
    const clones = [
        {
            ...
            originalBrand: "Sustainable Thrift Store",
            description: "A comprehensive e-commerce experience for a luxury thrift shop. Engineered with a focus on smooth page transitions, product discovery, and a minimalist luxury aesthetic.",
            features: [
            ...
            tags: ["React", "CSS Modules", "Vite", "Responsive Design"],
            icon: ShoppingBag,
            color: "bg-pink-500",
            reversed: false,
        ...
        {
            title: "Cetaphil",
            originalBrand: "Medical Skincare",
            description: "A precision-engineered replica of the Cetaphil medical skincare interface. Focuses on clean typography, detailed product grids, and corporate brand consistency.",
            features: [
                "Sticky Filtering Navigation",
                "Medical-Grade UI Aesthetics",
        ...
        {
            title: "True Classic",
            originalBrand: "Apparel Brand",
            description: "A high-conversion fashion e-commerce clone. Built to showcase complex product grids, best-seller carousels, and professional marketing-focused UI components.",
            features: [
                "E-commerce Grid Systems",
                "Marketing Badge Integration",
        ...
        {
            title: "iCalm",
            originalBrand: "Wellness Store",
            description: "A serene, minimalist wellness store interface. Prioritizes storytelling, whitespace, and accessibility to create a calming shopping atmosphere.",
            features: [
                "Minimalist Core UI",
                "Scroll-Triggered Reveal Animations",
                "Interactive Product Information",
                "Brand Storytelling Layouts"
            ],
            ...
            <div className="max-w-[1400px] mx-auto relative z-10">
                ...
                <div className="text-center mb-32">
                    ...
                    <p className="text-xl text-indigo-950/80 max-w-2xl mx-auto font-light leading-relaxed tracking-wide">
                        Precision-engineered replicas of world-class web interfaces, demonstrating attention to detail and expert frontend craftsmanship.
                    </p>
                </div>
        ...
        >
            ...
            <div className="w-full xl:w-2/5 text-center xl:text-left">
                <div className={`inline-flex items-center gap-3 mb-6 px-4 py-1.5 rounded-full bg-white/30 border border-indigo-900/10`}>
                    <span className="text-indigo-800 text-xs tracking-widest uppercase font-semibold">Clone of</span>
