...
import { ArrowLeft, ExternalLink, Github, Gamepad2, Target, Palette, MousePointer2, Youtube } from 'lucide-react';
...
const GamesArcade = () => {
    const games = [
        {
            title: "Whack-a-Mole",
            originalBrand: "Reaction Speed Game",
            description: "Classic arcade fun reimagined for the web. Smack the moles before they hide and test your reaction speed with a built-in high score system.",
            icon: Target,
            color: "bg-yellow-500",
            reversed: false,
        ...
        {
            title: "RGB Master",
            originalBrand: "Color Theory Challenge",
            description: "Test your color theory skills by guessing the correct color from the RGB code shown. A visual perception challenge that sharpens your design eye.",
            icon: Palette,
            color: "bg-blue-500",
            reversed: true,
        ...
        {
            title: "Click Counter",
            originalBrand: "Speed & Stress Test",
            description: "How fast can you click? A simple but addictive speed test and stress reliever with CPM tracking and personal best records.",
            icon: MousePointer2,
            color: "bg-pink-500",
            reversed: false,
            ...
            <div className="max-w-[1400px] mx-auto relative z-10">
                ...
                <div className="text-center mb-32">
                    ...
                    <p className="text-xl text-indigo-950/80 max-w-2xl mx-auto font-light leading-relaxed tracking-wide">
                        Interactive browser games built from scratch to explore game mechanics, animations, and real-time user interaction.
                    </p>
                </div>

                <div>
                    {games.map((game, index) => (
                        <ShowcaseItem key={index} {...game} />
                    ))}
                </div>
            </div>
        </div>
...
const ShowcaseItem = ({ title, description, originalBrand, color, icon: Icon, reversed, demoLink, repoLink, videoLink, image }) => {
        ...
        >
            ...
            <div className="w-full xl:w-2/5 text-center xl:text-left">
                <div className={`inline-flex items-center gap-3 mb-6 px-4 py-1.5 rounded-full bg-white/30 border border-indigo-900/10`}>
                    <span className="text-indigo-800 text-xs tracking-widest uppercase font-semibold">Game Type</span>
                ...
                <p className="text-lg md:text-xl text-indigo-950/80 mb-10 leading-relaxed font-light">
                    {description}
                </p>

                <div className="flex flex-wrap gap-4 justify-center xl:justify-start">
                    {demoLink && (
                        <a href={demoLink} target="_blank" rel="noopener noreferrer" className="px-8 py-4 rounded-full bg-indigo-900 text-white font-bold hover:bg-indigo-800 transition-transform hover:-translate-y-1 flex items-center gap-2 shadow-lg shadow-indigo-900/20">
